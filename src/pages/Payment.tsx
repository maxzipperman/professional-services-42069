...
const PaymentPage = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Make a Payment | Position Digital</title>
        <meta name="description" content="Secure online payment via Stripe. Pay your invoice quickly and safely with Position Digital." />
